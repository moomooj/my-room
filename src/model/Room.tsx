...
function Room(props: IProps) {
  ...
  const [computerOutline, setComputerOutline] = useState(false);
  const [lightOutline, setLightOutline] = useState(false);
  ...
  const outlineOn = (obj: string) => {
    if (obj === "computer") {
      setComputerOutline(true);
    } else if (obj === "light") {
      setLightOutline(true);
    }
  };
  const outlineOff = (obj: string) => {
    if (obj === "computer") {
      setComputerOutline(false);
    } else if (obj === "light") {
      setLightOutline(false);
    }
  };
    ...
    <>
      <group {...props} dispose={null}>
        ...
        <mesh
          ...
          onPointerEnter={() => outlineOn("computer")}
          onPointerOut={() => outlineOff("computer")}
        >
          <Outlines
            thickness={0.08}
            screenspace={false}
        ...
        <mesh
          ...
          onPointerEnter={() => outlineOn("light")}
          onPointerOut={() => outlineOff("light")}
        >
          <Outlines
            thickness={0.02}
            screenspace={false}
